...
const clerkAppearance = {
    ...
    elements: {
        ...
        form: "flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full",
        formFieldRow: "flex-1 min-w-0",
        formFieldInput:
            "bg-[#1a2332] border border-white/10 text-white placeholder:text-gray-500 focus:border-blue-500/50 focus:ring-0 h-14 rounded-full px-6 text-base w-full",
        formButtonPrimary:
            "bg-blue-600 hover:bg-blue-500 text-white font-semibold h-14 px-8 rounded-full shadow-[0_0_20px_rgba(37,99,235,0.3)] whitespace-nowrap text-base",
